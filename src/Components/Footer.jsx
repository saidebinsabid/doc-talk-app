      ...
      <footer className="footer footer-horizontal footer-center text-base-content rounded p-10 font-plus">
        ...
        <nav>
          <div className="grid grid-flow-col gap-4">
            ...
            <a href="https://www.facebook.com/saidebinsabid" target="_blank" rel="noopener noreferrer">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            <a href="https://www.linkedin.com/in/saide-bin-sabid-85238828b/" target="_blank" rel="noopener noreferrer">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
                y="0px"
